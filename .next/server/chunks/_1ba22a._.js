...
async function verifyPipeline(rawText, profile, provider, sources = []) {
    ...
    /* 1. Forensic Decomposition */ const claims = await __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$claims$2f$claim$2d$decomposer$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["decomposeClaimsAdvanced"](text, provider);
    /* 2. Reasoning & Evidence (Parallel) */ const links = __TURBOPACK__imported__module__$5b$project$5d2f$core$2f$claims$2f$claim$2d$linker$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["linkClaims"](claims);
    ...
    /* 3. Multi-Stage Risk Analysis (Parallel) */ const [semanticRisks, refutationRisks] = await Promise.all([
    ...
    /* 4. Scoring with Logic Gates */ const components = {
    ...
    /* Logic Gate: Force Audit Fail for High Severity Risks */ const hasCriticalFailure = allRisks.some((r)=>r.severity === "high");
...
//# sourceMappingURL=_1ba22a._.js.map